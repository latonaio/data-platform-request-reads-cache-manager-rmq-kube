package controllersSupplyChainRelationshipDetailGeneral
...
type SupplyChainRelationshipDetailGeneralController struct {
	beego.Controller
...
func (
	controller *SupplyChainRelationshipDetailGeneralController,
...
func (
	...
	for _, v := range *supplyChainRelationshipRes.Message.General {
		...
		data.SupplyChainRelationshipDetailGeneral = append(data.SupplyChainRelationshipDetailGeneral,
			apiOutputFormatter.SupplyChainRelationshipDetailGeneral{
