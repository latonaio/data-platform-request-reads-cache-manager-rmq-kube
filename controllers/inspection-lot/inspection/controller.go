package controllersInspectionLotInspection
...
type InspectionLotInspectionController struct {
	beego.Controller
...
func (controller *InspectionLotInspectionController) Get() {
	controller.UserInfo = services.UserRequestParams(&controller.Controller)
	redisKeyCategory1 := "inspection-lot"
	redisKeyCategory2 := "inspection-lot-inspection"
...
func (
	controller *InspectionLotInspectionController,
	...
	for _, v := range *inspectionLotInspectionsRes.Message.Inspection {
		data.InspectionLotInspection = append(data.InspectionLotInspection,
			apiOutputFormatter.InspectionLotInspection{
				...
				InspectionTypeCertificateType:            v.InspectionTypeCertificateType,
				...
				InspectionLotInspectionText:              v.InspectionLotInspectionText,
			},
		)
	}
