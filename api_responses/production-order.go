...
type ProductionOrderRes struct {
	...
	Message             ProductionOrderMessage `json:"message"`
...
type ProductionOrderMessage struct {
	Header                                       *[]ProductionOrderHeader                        `json:"Header"`
...
func CreateProductionOrderRes(msg rabbitmq.RabbitmqMessage) (*ProductionOrderRes, error) {
	res := ProductionOrderRes{}
