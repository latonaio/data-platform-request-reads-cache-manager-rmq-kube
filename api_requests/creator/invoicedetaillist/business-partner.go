...
func CreateBusinessPartnerReq(param *dpfm_api_input_reader.InvoiceDetailListParams, iRes *apiresponses.InvoiceRes, sID string, log *logger.Logger) *models.BusinessPartnerReq {
	bpIDs := make([]int, 0)
