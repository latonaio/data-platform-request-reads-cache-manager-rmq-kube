...
func CreateDescriptionReq(param *dpfm_api_input_reader.BillOfMaterialListParams, pvRes *apiresponses.BillOfMaterialRes, sID string, log *logger.Logger) *models.ProductMasterReq {
