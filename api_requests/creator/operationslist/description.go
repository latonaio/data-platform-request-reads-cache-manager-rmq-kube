...
func CreateDescriptionReq(param *dpfm_api_input_reader.OperationsListParams, opRes *apiresponses.OperationsRes, sID string, log *logger.Logger) *models.ProductMasterReq {
