...
func CreateProductRequest(param *dpfm_api_input_reader.ProductionOrderDetailParams, poRes *apiresponses.ProductionOrderRes, sID string, log *logger.Logger) *models.ProductMasterReq {
