...
func CreateProductMasterDocReq(param *dpfm_api_input_reader.OperationsDetailListParams, opRes *apiresponses.OperationsRes, sID string, log *logger.Logger) *models.ProductMasterDocReq {
