...
func CreateProductMasterDocReq(param *dpfm_api_input_reader.ProductionVersionListParams, pvRes *apiresponses.ProductionVersionRes, sID string, log *logger.Logger) *models.ProductMasterDocReq {
