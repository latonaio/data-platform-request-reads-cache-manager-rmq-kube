...
func CreateProductGroupReq(param *dpfm_api_input_reader.DeliveryDocumentDetailParams, productRes *apiresponses.ProductMasterRes, sID string, log *logger.Logger) *models.ProductGroupReq {
