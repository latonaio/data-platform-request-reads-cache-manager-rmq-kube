...
func CreateBusinessPartnerReq(param *dpfm_api_input_reader.DeliveryDocumentDetailParams, productRes *apiresponses.ProductMasterRes, oiRes *apiresponses.OrdersRes, sID string, log *logger.Logger) *models.BusinessPartnerReq {
