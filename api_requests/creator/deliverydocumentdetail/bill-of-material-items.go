...
func CreateBillOfMaterialItemsReq(param *dpfm_api_input_reader.DeliveryDocumentDetailParams, bmRes *apiresponses.BillOfMaterialRes, sID string, log *logger.Logger) *models.BillOfMaterialReq {
