...
func CreateBusinessPartnerReq(param *dpfm_api_input_reader.OrdersListParams, oRes *apiresponses.OrdersRes, sID string, log *logger.Logger) *models.BusinessPartnerReq {
	bpIDs := make([]int, 0)
