...
func CreateBusinessPartnerBuyerReq(param *dpfm_api_input_reader.OrdersListParams, productRes *apiresponses.ProductMasterRes, oiRes *apiresponses.OrdersRes, sID string, log *logger.Logger) *models.BusinessPartnerReq {
