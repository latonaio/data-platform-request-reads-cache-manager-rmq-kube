...
type SupplyChainRelationshipDetailList struct {
	...
	Params                      SupplyChainRelationshipDetailListParams `json:"Params"`
	ReqReceiveQueue             *string                                 `json:"responseReceiveQueue"`
}

type SupplyChainRelationshipDetailListParams struct {
	SupplyChainRelationship                  int     `json:"SupplyChainRelationship"`
...
func ReadSupplyChainRelationshipDetailList(msg rabbitmq.RabbitmqMessage) *SupplyChainRelationshipDetailList {
	d := SupplyChainRelationshipDetailList{}
