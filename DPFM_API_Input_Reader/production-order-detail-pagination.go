...
type ProductionOrderDetailPagination struct {
	...
	Params                      ProductionOrderDetailPagenationParams `json:"Params"`
	ReqReceiveQueue             *string                               `json:"responseReceiveQueue"`
}

type ProductionOrderDetailPagenationParams struct {
...
func ReadProductionOrderDetailPagination(msg rabbitmq.RabbitmqMessage) *ProductionOrderDetailPagination {
	d := ProductionOrderDetailPagination{}
