...
type ProductionVersionList struct {
	...
	Params                      ProductionVersionListParams `json:"Params"`
	ReqReceiveQueue             *string                     `json:"responseReceiveQueue"`
}

type ProductionVersionListParams struct {
...
func ReadProductionVersionList(msg rabbitmq.RabbitmqMessage) *ProductionVersionList {
	d := ProductionVersionList{}
