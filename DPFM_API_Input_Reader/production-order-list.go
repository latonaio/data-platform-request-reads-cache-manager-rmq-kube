...
type ProductionOrderList struct {
	...
	Params                      ProductionOrderListParams `json:"Params"`
	ReqReceiveQueue             *string                   `json:"responseReceiveQueue"`
}

type ProductionOrderListParams struct {
...
func ReadProductionOrderList(msg rabbitmq.RabbitmqMessage) *ProductionOrderList {
	d := ProductionOrderList{}
